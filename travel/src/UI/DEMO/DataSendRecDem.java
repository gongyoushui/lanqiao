...
class DataSendRecDemo extends JFrame{
    ...
    setTitle("The demo of the iphone send data");
    setSize(350,222);
    jPanel=new JPanel();
...
public class DataSendRecDem extends JFrame {
    public DataSendRecDem() {
        initComponents();
    }
